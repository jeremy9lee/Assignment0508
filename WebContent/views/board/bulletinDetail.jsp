					...
					<li>
						<table  style="width: 100%" class="table table-hover">
							...
							<tr>
								...
								<c:choose>
									...
									<c:otherwise>
										<td colspan='3'><a
											href="bulletin?a=bulletinDetail&no=${prevAndNext.prevNo}">${prevAndNext.prevTitle}</a></td>
									</c:otherwise>
								</c:choose>
							</tr>
							<tr>
								...
								<c:choose>
									...
									<c:otherwise>
										<td colspan='3'><a
											href="bulletin?a=bulletinDetail&no=${prevAndNext.nextNo}">${prevAndNext.nextTitle}</a></td>
									</c:otherwise>
								</c:choose>
						...
						<div id="buttonArea" align="right">
							<c:if test="${bulletin.memberno eq sessionNo}">
								<a href="bulletin?a=goToUpdateForm&no=${bulletin.b_no}"><input
									type="button" value="Modify" style="width: 100px" class="btn btn-info"></a>
								<a href="bulletin?a=bulletinDelete&b_no=${bulletin.b_no}"><input type="button"
								value="Delete" style="width: 100px" class="btn btn-info"></a>
							</c:if>
							<a href="bulletin?a=bulletinMain"><input type="button"
